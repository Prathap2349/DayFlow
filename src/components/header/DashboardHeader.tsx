      ...
      <header className="sticky top-0 z-20 flex items-center gap-3 px-4 sm:px-6 h-16 bg-white/95 backdrop-blur border-b border-slate-100 text-slate-900">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex items-center gap-2 p-2 sm:px-3 sm:py-1.5 rounded-xl border border-slate-200 hover:bg-slate-100 text-slate-500 text-sm transition-all shadow-sm focus-visible:outline-none"
            aria-label="Global Search"
          >
            <Search className="w-4 h-4 text-indigo-600" />
            <span className="hidden sm:inline text-xs font-medium text-slate-500">Search (Ctrl+K)</span>
          </button>
          ...
          <div className="relative">
            <button
              ...
              className="relative p-2 rounded-lg hover:bg-slate-100 text-slate-500 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500"
          ...
          <div className="bg-white rounded-2xl shadow-2xl border border-slate-100 w-full max-w-xl overflow-hidden animate-fade-in">
            <div className="flex items-center px-4 border-b border-slate-100">
              ...
              <input
                ...
                className="w-full py-4 text-sm text-slate-900 bg-transparent focus:outline-none placeholder:text-slate-400"
              />
              <button
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-3 text-xs text-slate-500 mt-0.5">
                        <span className="flex items-center gap-1">
                          <Building className="w-3 h-3 text-slate-400" /> {emp.department}
                        </span>
                        <span className="flex items-center gap-1">
